 ...
 */
(function () {
  const API_URL = (window.CoparentesWP && CoparentesWP.contactUrl) || '/wp-json/coparentes/v1/contact';

  const LEGAL_FALLBACK = {
    pl: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
    en: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
    de: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
    es: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
    fr: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
    zh: { terms: '/regulamin/', privacy: '/polityka-prywatnosci/' },
  };
  const LEGAL = (window.CoparentesWP && CoparentesWP.legal)
    ? { pl: CoparentesWP.legal, en: CoparentesWP.legal, de: CoparentesWP.legal, es: CoparentesWP.legal, fr: CoparentesWP.legal, zh: CoparentesWP.legal }
    : LEGAL_FALLBACK;
  ...
  const lang = (window.CoparentesWP && CoparentesWP.lang) || detectLang();
    ...
    try {
      const res = await fetch(API_URL, {
        ...
        headers: {
          ...
          ...(window.CoparentesWP && CoparentesWP.restNonce ? { 'X-WP-Nonce': CoparentesWP.restNonce } : {}),
        },
